def main():
    ...
    try:
        ...
        convert = parse_formula(formula, periodic_table)

        mass =  compute_molar_mass(convert)
        ...
        formula_2 = float(input("Mass in grams of the substance:"))

        moles = formula_2 / mass
        ...
        print(f"Error invalid formular:{formula} ")
...
def make_periodic_table():
    #takes no parameters and creates and returns a 
    # compound list that contains all the data in the 
    # table of elements in the Problem Statement section 
    # above. The data within the compound table should be
    #  organized like this:
    table = {
...
def compute_molar_mass(symbol_quantity_list, periodic_table):
    ...
    mass = compute_molar_mass
    for symbol, quantity in mass.items():
